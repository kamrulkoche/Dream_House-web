    	...
    	<form action="../Controller/buyeraction.php" target="_self" method="POST" onsubmit="return validbuyer(this)" novalidate>
    				...
    				<tbody>
    					...
    					<tr>
    						...
    						<td><label for="Number"></label>
    							<input type="Number" name="Number" placeholder="Phone" autofocus>
