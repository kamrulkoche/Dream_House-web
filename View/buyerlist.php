...
if (!isset($_COOKIE['rem'])) {
    header('location: /AdminFinal Project/View/Logout.php');
}
...
<body>
    <fieldset style="width: 100%;  overflow: scroll;">
        <legend><b>Buyer List</b></legend>
        <h3 align="center">Buyer List</h3>
        <form action="../Controller/searchbuyeraction.php" method="get" onsubmit="buyer(this); return false;">
                ...
                <tbody>
                    ...
                    if ($qry->num_rows > 0) {
                        while ($data = $qry->fetch_assoc()) {
                            ...
                            // echo "<td><a href='/Admin FInal Project/View/editbuyer.php?id=" . $data['ID'] . "'>Edit</a></td>";
                            echo "<td><a href='/Admin FInal Project/Controller/deletebuyeraction.php?id=" . $data['ID'] . "'>Delete</a></td>";
                            echo "</tr>";
                        }
                    } else {
                        echo "<tr>";
        ...
        <h3 align="center"><a href="buyer.php">Add Buyer</a></h3>
    </fieldset>
    <br>
