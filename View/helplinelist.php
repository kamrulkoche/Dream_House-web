                ...
                <tbody>
                    ...
                    if ($qry->num_rows > 0) {
                        while ($data = $qry->fetch_assoc()) {
                            ...
                            // echo "<td><a href='/FInal Project/View/edithelpline.php?id=" . $data['ID'] . "'>Edit</a></td>";
                            // echo "<td><a href='/FInal Project/Controller/deletehelplineaction.php?id=" . $data['ID'] . "'>Delete</a></td>";
                            // echo "</tr>";
                        }
                    } else {
                        echo "<tr>";
