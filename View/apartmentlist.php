...
<body>
    <fieldset style="width: 60%; height: 450px; overflow: scroll;">
        ...
        <form action="../Controller/searchapartmentaction.php" method="get" onkeyup="apartment(this); return false;">
                🔎<input type="text" id="search" name="Search" placeholder="Search BDT">
                ...
                <tbody>
                    ...
                    if ($qry->num_rows > 0) {
                        while ($data = $qry->fetch_assoc()) {
                            ...
                            echo "<td><a href='/FInal Project/Controller/deleteapartmentaction.php?id=" . $data['ID'] . "'>Delete</a></td>";
                            echo "</tr>";
                        }
                    } else {
                        echo "<tr>";
