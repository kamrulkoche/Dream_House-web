...
<body>
	...
	if ($_SERVER['REQUEST_METHOD'] === "POST") {
		...
		if (!$flag) {
			insert_sellerDB($_POST['FirstName'], $_POST['LastName'], $_POST['Gender'], $_POST['NID'], $_POST['Sold']);
			// setcookie('msg', '<b>✅Registration uccessful!</b><br>', time() + 1, '/');
		} else {
			setcookie('msg', '<b>❌Seller ADD NOT Successful!</b><br>', time() + 1, '/');
			header('location: ../View/sellerlist.php');
		}
	}
	?>